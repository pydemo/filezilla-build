...
/* ./.libs/lt-filezilla.c - temporary wrapper executable for .libs/filezilla.exe
   Generated by libtool (GNU libtool) 2.4.6

   The filezilla program cannot be directly executed until all the libtool
...
const char * EXE_PATH_VALUE   = "C;C:\\tmp\\msys64\\tmp\\msys64\\home\\alex_buz\\prefix\\lib;C;C:\\tmp\\msys64\\tmp\\msys64\\home\\alex_buz\\prefix\\bin;C:\\tmp\\msys64\\home\\alex_buz\\prefix\\lib;C:\\tmp\\msys64\\home\\alex_buz\\prefix\\bin;";
const char * TARGET_PROGRAM_NAME = "filezilla.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# filezilla - temporary wrapper script for .libs/filezilla.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The filezilla program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"filezilla.exe:filezilla:$LINENO: libtool wrapper (GNU libtool) 2.4.6\"", f);
  fputs (" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"filezilla.exe:filezilla:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"filezilla.exe:filezilla:$LINENO: newargv[0]: $progdir/$program\" ", f);
  fputs ("1>&2\n", f);
  ...
  fputs ("    PATH=C:/tmp/msys64/home/alex_buz/prefix/lib:C:/tmp/msys64/home/alex_buz/pre", f);
  fputs ("fix/bin:/home/alex_buz/prefix/lib:/home/alex_buz/prefix/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    if test \"$libtool_execute_magic\" != \"%%%MAGIC variable%%%\"; then\n", f);

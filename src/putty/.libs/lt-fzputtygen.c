...
/* ./.libs/lt-fzputtygen.c - temporary wrapper executable for .libs/fzputtygen.exe
   Generated by libtool (GNU libtool) 2.4.6

   The fzputtygen program cannot be directly executed until all the libtool
...
const char * EXE_PATH_VALUE   = "C;C:\\tmp\\msys64\\tmp\\msys64\\home\\alex_buz\\prefix\\lib;C;C:\\tmp\\msys64\\tmp\\msys64\\home\\alex_buz\\prefix\\bin;";
const char * TARGET_PROGRAM_NAME = "fzputtygen.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# fzputtygen - temporary wrapper script for .libs/fzputtygen.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The fzputtygen program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"fzputtygen.exe:fzputtygen:$LINENO: libtool wrapper (GNU libtool) 2.4.", f);
  fputs ("6\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"fzputtygen.exe:fzputtygen:$LINENO: newargv[$lt_dump_args_N]: $lt_arg", f);
  fputs ("\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"fzputtygen.exe:fzputtygen:$LINENO: newargv[0]: $progdir/$program", f);
  fputs ("\" 1>&2\n", f);
